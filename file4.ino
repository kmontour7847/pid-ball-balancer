...
int set=18.5,neg=-20,pos=60,base=90;//Setpoint,Negative,Positive,Base values.neg shows tilt on other side of ultrasonic sensor   6,-24,24,130
...
float Kp = 13.35;                                                    //Initial Proportional Gain  0.8     get ball to setpoint
float Ki = 2;                                                      //Initial Integral Gain 0.02        balance
float Kd = 7.5;                                                    //Intitial Derivative Gain 0.75      stop ball at setpoint
